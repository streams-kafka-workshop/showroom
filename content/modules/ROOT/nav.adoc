...
** xref:m2/module-02.3.adoc[Running the simple Streaming Application]
** xref:m2/module-02.4.adoc[Globex Activity Tracking Application]
** xref:m2/module-02.5.adoc[Quarkus and Kafka: Better Together]
...
* xref:m6/module-06.0.adoc[Module 6 - Security]
