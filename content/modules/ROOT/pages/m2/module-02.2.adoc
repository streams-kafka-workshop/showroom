...
* THe temrinal has multiple java versions installed. For the sake of consistency across the workshop make sure you are using java 17 by running the following command.
+
...
* Replace the bootstrap servers placeholder value(line 10) with the following value.
+
[source,bash,role="execute",subs=attributes+]
----
