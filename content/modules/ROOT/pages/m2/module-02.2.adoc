...
== Istio Authorization Concepts and Architecture
...
Flexible semantics: Operators can define custom conditions on Istio attributes and use the *CUSTOM*, *DENY*, and *ALLOW* actions.
