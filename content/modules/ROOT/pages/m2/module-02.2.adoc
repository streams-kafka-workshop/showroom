...
* You should see an error being thrown continuously in the terminal output. Press *ctrl+c* to stop the producer after observing the error.
...
* Run the producer by entering `1` and press enter .
