...
* For the *Enter number of messages* prompt. Enter the below value and press enter. You will observe the delay before the messages are displayed.
+
[source,bash,role="execute",subs=attributes+]
----
30
...
=== Cleanup
* Make sure exit the application by pressing *ctrl+c* in the terminal window.
