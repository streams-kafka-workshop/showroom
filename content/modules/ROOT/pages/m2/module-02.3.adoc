...
. Let us now look at the consumer code. In the `module-kafka-api` folder, click on the *src/main/java/com/kafka/tutorial/SimpleKafkaConsumer.java* file in the file explorer to open it.
+
