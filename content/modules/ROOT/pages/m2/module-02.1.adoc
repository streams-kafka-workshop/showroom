...
. Navigate to the {ocp_cluster_openshift_cluster_console_url}[OpenShift Console, window="console"], and log in with username `admin` and password `{ocp_cluster_openshift_cluster_admin_password}`if prompted.
