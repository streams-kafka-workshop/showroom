...
* Let us now look at the producer code. In the `module-kafka-api` folder, click on the *src/main/java/com/kafka/tutorial/SimpleKafkaProducer.java* file in the file explorer to open it.
+
