...
* Navigate to {openshift_cluster_console}/topology/all-namespaces?view=graph[OpenShift Cluster Console, window="_console"]. Login with your username and password ({user_name}/{password}).
