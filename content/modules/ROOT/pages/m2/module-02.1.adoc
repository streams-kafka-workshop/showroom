...
. Before starting this module, make sure you have exited from the RHEL server from the previous module. In the lower terminal, type `exit` to exit out of the RHEL system.
+
