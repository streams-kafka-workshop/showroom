...
* Let's double check if this user can write to the topic. Since this user is for consumers they should not be able to write to the topic. Navigate to the *upper terminal* and run the following command. 
+
[source,sh,role="execute",subs=attributes+]
----
