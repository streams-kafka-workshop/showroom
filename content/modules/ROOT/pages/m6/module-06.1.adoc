...
* Login to the project namespace `kafka-{user_name}` using the following command in a terminal. 
+
...
* We've already created a admin users on this cluster with all the previliges. 
