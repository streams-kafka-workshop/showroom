...
Now that the Platform Engineer has made the Gateway available, Developers/App Owners can now configure secure access to their service endpoints.

== Activity: Developer workflow

In this section, you will perform the role of a developer and create policies to securely expose the core service endpoints. This will allow partner portals to securely access {corp}'s flights, hotels, and car offerings.
