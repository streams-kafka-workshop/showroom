...
+
NOTE: For the sake of the workshop, we have chosen to authentication using a simplistic API Key. In real world, you may consider using a JWT/OAuth access token to authenticate the requests.
