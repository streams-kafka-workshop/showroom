...
All incoming traffic from the external partner portal need to be secured and managed. {corp} also wants to protect the endpoints by easily applying rate limiting and specific levels of access based on systems and users.
...
. The access to core services (Travels) service endpoint needs to be secured and protected for connectivity from the partner portals that are being onboarded.
