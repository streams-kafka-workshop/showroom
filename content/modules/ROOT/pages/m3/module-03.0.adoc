...
Platform Engineers can apply policies to the Gateway which governs the the lower levels of the network (HTTPRoute/Services), until a more specific policy is applied.
