...
{rhcl} extends the capabilities of https://gateway-api.sigs.k8s.io/[*Gateway API*^, window='content'], the new Kubernetes standard for Ingress. The , and offers Policy APIs to support DNS management, TLS certificate lifecycle management, authentication, and rate limiting.
