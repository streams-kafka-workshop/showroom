...
. Click to navigate to {ocp_cluster_openshift_cluster_console_url}/kuadrant/overview[Connectivity Link Overview^, window='content']. +
Login as *admin/{ocp_cluster_openshift_cluster_admin_password}* if prompted.
+
