...
+
[TIP] DNS Policies can be created with more complex configurations especially for hybrid cloud architectures, including default Geo Code and load balancing options
