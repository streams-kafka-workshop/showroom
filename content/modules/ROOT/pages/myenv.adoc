...
| GitOps/Argo (Platform setup) | https://openshift-gitops-server-openshift-gitops.{ocp_cluster_openshift_cluster_ingress_domain}[click here^, window="argo"] | {ocp_cluster_openshift_gitops_user}/{ocp_cluster_openshift_gitops_password}
