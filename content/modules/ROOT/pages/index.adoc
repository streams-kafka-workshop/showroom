...
*{streams}* is Kafka built for OpenShift/Kubernetes” : This product can also be deployed on RHEL or other systems that support JVM supported by us, even though Strimzi can’t. *{streams}* provides a the following advantages:
