...
. Click https://amq-streams-console-{user_name}.{openshift_cluster_subdomain}/kafka/[here, window="console"] to navigate to the streams console to view the topic you created. The streams console is a web-based user interface for visualizing and monitoring Kafka clusters, topics, messages etc.
