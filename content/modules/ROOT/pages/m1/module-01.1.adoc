...
.. You can ignore the rest of the steps since you will use a script to directly convert and transfer it to the on-premises RHEL server.
...
[source,sh,role="execute",subs=attributes+]
----
oc apply -f https://raw.githubusercontent.com/rpscodes/app_connectivity_summit25/refs/heads/main/manifest.yaml -n travel-db
----
+
