...
. Navigate to the https://amq-streams-console-{user_name}.{openshift_cluster_domain}/kafka[streams console, window="console"] > topics > replicated and verify that the topic `replicated` is created with 3 partitions
+
