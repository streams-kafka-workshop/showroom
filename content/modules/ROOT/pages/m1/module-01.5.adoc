...
* In the *upper terminal*, stop the existing producer and consumer by typing (Ctrl+C) in the upper and *lower terminal*. Now in the *upper terminal*, let's run a new producer that accepts key-value pairs.
