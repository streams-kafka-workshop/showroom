...
Brokers: manage the storage of data and serve client traffic .
...
* In OpenShift/{streams} with KRaft + Node Pools:
...
This concludes a very high-level overview of how Kafka clusters and brokers work. In the next section we'll learn about Kafka topics and create a topic.
