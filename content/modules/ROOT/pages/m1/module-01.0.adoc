...
* Click https://amq-streams-console-{user_name}.{openshift_cluster_subdomain}/kafka/[here, window="console"] to navigate to the {streams} console.
...
* Under the *Kafka cluster details* section, you will find details such as the name of the cluster, the number of brokers andthe Kafka version
+
