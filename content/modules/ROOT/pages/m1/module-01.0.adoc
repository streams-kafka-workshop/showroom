...
In the module, you will be guided through setting up a service network between the {corp}'s core services running on OpenShift in the public cloud (AWS in this case) and the travels database (`travels-db`), running on RHEL.
