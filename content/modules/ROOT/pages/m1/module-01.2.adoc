...
* Sending related messages using the same key so they go to the same partition is a mandatory precondition to achieve strict ordering within a partition.
