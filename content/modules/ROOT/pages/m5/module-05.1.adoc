...
=== Up Next
In the next section, we will see how the producer and consumer application use this schema to send and receive messages and make sure that the messages conform to the schema.
