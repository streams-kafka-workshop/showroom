...
* Navigate to the {registry} UI by clicking the link: https://schema-registry-ui-{user_name}.{openshift_cluster_subdomain}[Schema Registry, window="_schema-registry"].
...
* On the next screen, under the cotents section, copy and paste the below schema. Leave the Version number field blank.
+
