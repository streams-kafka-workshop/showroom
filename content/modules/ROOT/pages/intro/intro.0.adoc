...
. Secure external access to their core services from third-party partner portals
...
A number of components are preconfigured to enable the execution of this workshop within a short timeframe. We will discuss each of this throughout the course of this workshop.
