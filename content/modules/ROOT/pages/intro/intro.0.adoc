...
Here is an overview of the different types of instructions you'll find 
...
----
* You can adjust the width of this instructions and the right-side terminals windows with the resize grab handles.
+
