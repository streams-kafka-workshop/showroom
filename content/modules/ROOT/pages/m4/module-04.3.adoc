...
* Navigate to the browser tab with the link:https://devspaces.{openshift_cluster_subdomain}[Devspaces IDE, window="devspaces"]Devspaces IDE opened from the previous section.
